...
**Companion research doc:** [V2/3-Year Projected TCO.md](../../../../Glean/Combined/4.9.7%20Pricing%20&%20TCO/V2/3-Year%20Projected%20TCO.md)
...
**Sr No mapping:** Sr No 1-6 below map 1:1 to the same Sr No in the companion research doc's claims table [Combined/V2/3-Year Projected TCO.md](../../../../Glean/Combined/4.9.7%20Pricing%20&%20TCO/V2/3-Year%20Projected%20TCO.md#claims-sr-no-1-6-mapped-to-test-guide) — same number, same claim, doc-sourced there / tenant-tested here.
...
Once every row above has a Result filled in, copy the Pass/Fail/Partial/Blocked counts back into the companion research doc [V2/3-Year Projected TCO.md](../../../../Glean/Combined/4.9.7%20Pricing%20&%20TCO/V2/3-Year%20Projected%20TCO.md), and specifically record your organization's real, completed 3-year TCO total (Sr No 6) — that is this field's actual deliverable, not the rough triangulated range.
