---
url: "https://docs.glean.com/get-started/golive/automate-tasks-with-agents-and-tools"
canonical: "https://docs.glean.com/get-started/golive/automate-tasks-with-agents-and-tools"
title: "Automate tasks with agents and tools"
description: "Use Glean agents and tools to automate repetitive tasks, run multi-step workflows, and take action across your connected apps."
fetched_at: "2026-09-01T13:29:49.094Z"
---
On this page
...
In the **Get the most out of Glean** section, select **Automate tasks by enabling AI-powered agents and actions**.

![Automate tasks with agents and tools](/img/get-started/automate-tasks-with-agents-and-tools-task.webp)

Automate tasks with agents and tools

To explore agents and tools directly, go to the [Agents](/agents/) and [Tools](/administration/tools/) sections of the docs.
...
A common first step is to enable tools for the connectors your teammates use most. For example, if your team lives in Slack and Jira, enabling the Slack and Jira tools lets agents draft messages and update tickets directly from Glean Assistant.
