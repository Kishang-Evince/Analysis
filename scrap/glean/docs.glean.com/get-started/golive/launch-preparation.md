...
Because implementing Glean across your organization can be a transformative step in enhancing productivity and streamlining information access, your Glean rollout strategy is critical.
...
## Identify users[​](#identify-users "Direct link to Identify users")
...
### Encourage organic growth[​](#encourage-organic-growth "Direct link to Encourage organic growth")

Promoting organic growth is essential for the successful adoption of Glean across your organization. Often, colleagues of the initial users will notice the benefits of Glean and express interest in trying it themselves. Facilitate this process by allowing open access, which can significantly enhance the tool's acceptance and usage.

## Survey users[​](#survey-users "Direct link to Survey users")
...
### Initial survey template[​](#initial-survey-template "Direct link to Initial survey template")
...
## Establish feedback channels[​](#establish-feedback-channels "Direct link to Establish feedback channels")
...
## Schedule a live kickoff session[​](#schedule-a-live-kickoff-session "Direct link to Schedule a live kickoff session")
...
### Session planning[​](#session-planning "Direct link to Session planning")
...
-   **Topics:**
    ...
    -   How to use Glean to find answers and generate content.
...
### Set expectations[​](#set-expectations "Direct link to Set expectations")

Make it clear that while Glean is powerful, it will not be able to surface content from apps or connectors that it is not yet connected to.

### Encourage feedback[​](#encourage-feedback "Direct link to Encourage feedback")
...
## Schedule office hours[​](#schedule-office-hours "Direct link to Schedule office hours")
...
## Send communications to users[​](#send-communications-to-users "Direct link to Send communications to users")
...
> -   **Your New AI Glean:** Glean assists by providing instant answers, generating content, and automating repetitive tasks, all within seconds.
