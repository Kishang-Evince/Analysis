---
url: "https://docs.glean.com/get-started/golive/customize-branding"
canonical: "https://docs.glean.com/get-started/golive/customize-branding"
title: "Customize how Glean looks to match your brand"
description: "As your teammates start using Glean, customize the logo, color palette, and home-page background to match your company's branding."
fetched_at: "2026-09-01T13:29:49.458Z"
---
On this page
...
In the **Roll out Glean to your organization** section, select **Customize how Glean looks to match your brand**.

![Customize how Glean looks to match your brand](/img/get-started/customize-branding-task.webp)

Customize how Glean looks to match your brand

To open this task directly, go to **Customization → Appearance** in the **Admin console**. To skip and customize later, select the **Skip** option.
