---
url: "https://docs.glean.com/get-started/golive/enhance-results-with-more-connectors"
canonical: "https://docs.glean.com/get-started/golive/enhance-results-with-more-connectors"
title: "Enhance results with more connectors"
description: "Once your initial users are searching in Glean, expand search coverage by connecting more of your company's apps from the Glean connector catalog."
fetched_at: "2026-09-01T13:29:49.294Z"
---
On this page
...
## Open the connector catalog[​](#open-the-connector-catalog "Direct link to Open the connector catalog")

In the **Get the most out of Glean** section, select **Add more connectors to improve results**.

![Enhance results with more connectors](/img/get-started/enhance-results-with-more-connectors-task.webp)

Enhance results with more connectors

To browse connectors directly, go to the [Connectors Hub](/connectors/).
