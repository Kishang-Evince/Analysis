---
url: "https://docs.glean.com/troubleshooting/error-codes/gitlab/gitlab-5"
canonical: "https://docs.glean.com/troubleshooting/error-codes/gitlab/gitlab-5"
title: "GITLAB_5"
description: "GITLAB_5 Error Code"
fetched_at: "2026-09-01T13:30:20.811Z"
---
On this page

## Issue[​](#issue "Direct link to Issue")

Glean could not create webhooks for your GitLab connector because the configured personal access token (PAT) is missing the `api` scope.
...
2.  On the GitLab connector setup page, enter the new token and keep **API token has write privileges** checked.
...
2.  Follow the "Create Webhooks Manually" steps on the GitLab connector page to add a webhook for each group or project you want crawled.
