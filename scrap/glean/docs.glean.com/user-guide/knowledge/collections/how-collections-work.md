---
url: "https://docs.glean.com/user-guide/knowledge/collections/how-collections-work"
canonical: "https://docs.glean.com/user-guide/knowledge/collections/how-collections-work"
...
fetched_at: "2026-09-01T13:30:40.935Z"
---
On this page

Deprecated

Collections are an easy way to organize related documents across all your tools by a single topic. You can think of them as a way to curate a set of documents for other users to find and use easily.
...
Group those docs into a collection so your users can find what they need quickly.
...
## Add items to a Collection[​](#add-items-to-a-collection "Direct link to Add items to a Collection")

### From the collection page[​](#from-the-collection-page "Direct link to From the collection page")
...
### **From the search results page**[​](#from-the-search-results-page "Direct link to from-the-search-results-page")
...
## Add descriptions to collection items[​](#add-descriptions-to-collection-items "Direct link to Add descriptions to collection items")
...
## See Collections in search results[​](#see-collections-in-search-results "Direct link to See Collections in search results")
...
## View all collections across your company[​](#view-all-collections-across-your-company "Direct link to View all collections across your company")
...
## Organize Collections[​](#organize-collections "Direct link to Organize Collections")

You can organize Collections into sections using [Headers](/user-guide/knowledge/collections/organizing-collections-using-headers) or create [Subcollections](/user-guide/knowledge/collections/providing-informational-hierarchy-using-subcollections) to nest collections within.

* * *

## Edit sharing permissions on Collections[​](#edit-sharing-permissions-on-collections "Direct link to Edit sharing permissions on Collections")

You can update permissions for which users or departments should have edit access to the contents of any collection using the Share button.

* * *

## Questions? Feature requests?[​](#questions-feature-requests "Direct link to Questions? Feature requests?")
