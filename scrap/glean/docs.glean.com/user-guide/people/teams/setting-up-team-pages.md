---
url: "https://docs.glean.com/user-guide/people/teams/setting-up-team-pages"
canonical: "https://docs.glean.com/user-guide/people/teams/setting-up-team-pages"
title: "Setting up Team Pages"
description: "Create and manage team pages in Glean's Directory so employees can find who's on each team and how to reach them."
fetched_at: "2026-09-01T13:30:42.662Z"
---
On this page

It can be hard to coordinate efforts between groups of people at your company, and Glean's teams pages are here to help. These pages provide a single hub for people at your company to learn about who's working together, and what they're working on. This help article will guide you through the process of setting up teams; for more information on how to use team pages, see [this article](/user-guide/people/teams/how-to-use-team-pages). *Note:* *Only admins and users with team moderator permissions can set up teams.*
...
-   **People data in Glean**: You can also create teams from eligible fields (for example, department, role, location, or team) in your company's people data. This data is typically populated from your single sign-on system, such as Google Workspace, Okta or Azure Active Directory. You can use multiple people data fields to create teams, so your company can have pages based on departments, locations and other facets.

While not recommended, Glean also supports manually creating teams through our Push API. For more information on that, contact your Account Manager or Delivery Excellence Manager.
