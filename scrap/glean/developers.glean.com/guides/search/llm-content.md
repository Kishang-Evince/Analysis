...
canonical: "https://developers.glean.com/guides/search/llm-content"
title: "Returning LLM Content Over Snippets | Glean Developer"
description: "Learn how to request LLM content over snippets using the search API."
fetched_at: "2026-09-01T13:23:03.106Z"
---
On this page
...
```
{  "query": "mentions",   "pageSize": 10,   "maxSnippetSize": 4000,  "requestOptions": {    "returnLlmContentOverSnippets": true  }}
```

## Reading the Search Response[​](#reading-the-search-response "Direct link to Reading the Search Response")
...
### Non-LLM Content[​](#non-llm-content "Direct link to Non-LLM Content")
...
```
{  "results": [    {      ... more fields...      "snippets": [        {          "mimeType": "text/plain",          "ranges": [            {              "endIndex": 16,              "startIndex": 8,              "type": "BOLD"            }          ],          "snippet": "",          "snippetTextOrdering": 1,          "text": "Testing mentions"        },        {          "mimeType": "text/plain",          "ranges": [            {              "endIndex": 13,              "startIndex": 5,              "type": "BOLD"            }          ],          "snippet": "",          "snippetTextOrdering": 2,          "text": "This mentions user 1"        }        ... more snippets ...      ]      ... more fields ...    }  ]}
```

### LLM Content[​](#llm-content "Direct link to LLM Content")
...
```
{  "results": [    {      ... more fields...      "snippets": [        {          "mimeType": "text/plain",          "text": "Testing mentions",          "snippet": ""        },        {          "mimeType": "text/plain",          "text": "This mentions user 1",          "snippet": ""        }      ]      ... more snippets ...    }    ... more fields ...  ]}
```

## FAQ[​](#faq "Direct link to FAQ")

### Will maxSnippetSize be honored when returnLlmContentOverSnippets is False?[​](#will-maxsnippetsize-be-honored-when-returnllmcontentoversnippets-is-false "Direct link to Will maxSnippetSize be honored when returnLlmContentOverSnippets is False?")
...
### Is text generated when using returnLlmContentOverSnippets?[​](#is-text-generated-when-using-returnllmcontentoversnippets "Direct link to Is text generated when using returnLlmContentOverSnippets?")
...
### Is there a cap on the maximum number of snippets returned per document?[​](#is-there-a-cap-on-the-maximum-number-of-snippets-returned-per-document "Direct link to Is there a cap on the maximum number of snippets returned per document?")
...
### Why do I see irrelevant content when using returnLlmContentOverSnippets?[​](#why-do-i-see-irrelevant-content-when-using-returnllmcontentoversnippets "Direct link to Why do I see irrelevant content when using returnLlmContentOverSnippets?")
...
```
...more text...My favorite fruit is apples. I don't like taking tests. Today is Monday.... more text ...
```
...
## Tips on Usage[​](#tips-on-usage "Direct link to Tips on Usage")
...
## Still in Development[​](#still-in-development "Direct link to Still in Development")
