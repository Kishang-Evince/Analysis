---
url: "https://developers.glean.com/libraries/web-sdk/reference/interfaces/ModalSearchOptions"
canonical: "https://developers.glean.com/libraries/web-sdk/reference/interfaces/ModalSearchOptions"
title: "ModalSearchOptions | Glean Developer"
description: "Extends"
fetched_at: "2026-09-01T13:23:06.631Z"
---
On this page
...
### onDetach?[​](#ondetach "Direct link to onDetach?")
...
### showNativeSearchToggle?[​](#shownativesearchtoggle "Direct link to showNativeSearchToggle?")

```
optional showNativeSearchToggle?: boolean;
```

Specifies whether the user should see an option allowing them to revert back to the native search experience.
