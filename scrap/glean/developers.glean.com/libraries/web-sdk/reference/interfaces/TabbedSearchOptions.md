---
url: "https://developers.glean.com/libraries/web-sdk/reference/interfaces/TabbedSearchOptions"
canonical: "https://developers.glean.com/libraries/web-sdk/reference/interfaces/TabbedSearchOptions"
title: "TabbedSearchOptions | Glean Developer"
description: "Extends"
fetched_at: "2026-09-01T13:23:07.103Z"
---
On this page

## Extends[​](#extends "Direct link to Extends")

-   [`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions)
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`authMethod`](/libraries/web-sdk/reference/interfaces/SearchOptions#authmethod)
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`authToken`](/libraries/web-sdk/reference/interfaces/SearchOptions#authtoken)

* * *

### autoExpand?[​](#autoexpand "Direct link to autoExpand?")

```
optional autoExpand?: boolean;
```

If true, the search results frame will automatically expand its height to match the content, removing the need for an internal scrollbar. The embedder is responsible for providing a scrollable container around the widget.
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`backend`](/libraries/web-sdk/reference/interfaces/SearchOptions#backend)
...
### defaultResultTabs?[​](#defaultresulttabs "Direct link to defaultResultTabs?")

```
optional defaultResultTabs?: string[];
```

A list of result tabs to show by default. Other result tabs (if available) will be visible via the filter selector button.
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`disableAnalytics`](/libraries/web-sdk/reference/interfaces/SearchOptions#disableanalytics)
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`disableAssistant`](/libraries/web-sdk/reference/interfaces/SearchOptions#disableassistant)
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`domainsToOpenInCurrentTab`](/libraries/web-sdk/reference/interfaces/SearchOptions#domainstoopenincurrenttab)
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`enable3PCookieAccessRequest`](/libraries/web-sdk/reference/interfaces/SearchOptions#enable3pcookieaccessrequest)
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`enableActivityLogging`](/libraries/web-sdk/reference/interfaces/SearchOptions#enableactivitylogging)
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`externalSessionId`](/libraries/web-sdk/reference/interfaces/SearchOptions#externalsessionid)
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`externalUserId`](/libraries/web-sdk/reference/interfaces/SearchOptions#externaluserid)
...
Filters applied on all searches done by the user. Any filters in this list will override any manually input filters from users or filters defined in [initialFilters](/libraries/web-sdk/reference/interfaces/SearchOptions#initialfilters) that share the same key. These filters are non-modifiable by the user, and will not show up in the UI as being applied.
...
-   Any filters defined in [initialFilters](/libraries/web-sdk/reference/interfaces/SearchOptions#initialfilters) with `keyA` will be ignored.
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`filters`](/libraries/web-sdk/reference/interfaces/SearchOptions#filters)
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`fontFaces`](/libraries/web-sdk/reference/interfaces/SearchOptions#fontfaces)
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`fontFamily`](/libraries/web-sdk/reference/interfaces/SearchOptions#fontfamily)
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`fontSize`](/libraries/web-sdk/reference/interfaces/SearchOptions#fontsize)
...
### hideFiltersColumn?[​](#hidefilterscolumn "Direct link to hideFiltersColumn?")
...
### hideTopBarFilters?[​](#hidetopbarfilters "Direct link to hideTopBarFilters?")
...
Use [filters](/libraries/web-sdk/reference/interfaces/SearchOptions#filters) instead.

#### Inherited from[​](#inherited-from-17 "Direct link to Inherited from")

[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`initialFilters`](/libraries/web-sdk/reference/interfaces/SearchOptions#initialfilters)
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`key`](/libraries/web-sdk/reference/interfaces/SearchOptions#key)
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`locale`](/libraries/web-sdk/reference/interfaces/SearchOptions#locale)
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`onAuthTokenRequired`](/libraries/web-sdk/reference/interfaces/SearchOptions#onauthtokenrequired)
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`onChat`](/libraries/web-sdk/reference/interfaces/SearchOptions#onchat)
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`query`](/libraries/web-sdk/reference/interfaces/SearchOptions#query)

* * *

### searchBoxCustomizations?[​](#searchboxcustomizations "Direct link to searchBoxCustomizations?")
...
### showAutocompleteContent?[​](#showautocompletecontent "Direct link to showAutocompleteContent?")

```
optional showAutocompleteContent?: boolean;
```

When the inline search box is visible, this option allows displaying autocomplete content in place of search results when the search query is empty.

Note that this option is mutually exclusive with 'showHomePageContent', and if both are set, 'showHomePageContent' takes precedence.

* * *

### showHomePageContent?[​](#showhomepagecontent "Direct link to showHomePageContent?")

```
optional showHomePageContent?: boolean;
```

Whether to show home page content in place of search results when the search query is empty.

* * *

### showInlineSearchBox?[​](#showinlinesearchbox "Direct link to showInlineSearchBox?")
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`theme`](/libraries/web-sdk/reference/interfaces/SearchOptions#theme)
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`themeVariant`](/libraries/web-sdk/reference/interfaces/SearchOptions#themevariant)

* * *

### topBarFilterOverrides?[​](#topbarfilteroverrides "Direct link to topBarFilterOverrides?")

```
optional topBarFilterOverrides?: FilterConfig[];
```

If specified, these filters will be displayed in the top bar above the results pane instead of the default filters, in the order specified.
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`unauthorizedMessage`](/libraries/web-sdk/reference/interfaces/SearchOptions#unauthorizedmessage)
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`urlsToOpenInCurrentTab`](/libraries/web-sdk/reference/interfaces/SearchOptions#urlstoopenincurrenttab)
...
[`SearchOptions`](/libraries/web-sdk/reference/interfaces/SearchOptions).[`webAppUrl`](/libraries/web-sdk/reference/interfaces/SearchOptions#webappurl)
