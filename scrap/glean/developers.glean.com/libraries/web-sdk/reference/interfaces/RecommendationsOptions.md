---
url: "https://developers.glean.com/libraries/web-sdk/reference/interfaces/RecommendationsOptions"
canonical: "https://developers.glean.com/libraries/web-sdk/reference/interfaces/RecommendationsOptions"
title: "RecommendationsOptions | Glean Developer"
description: "Extends"
fetched_at: "2026-09-01T13:23:06.575Z"
---
On this page

## Extends[​](#extends "Direct link to Extends")

-   [`Options`](/libraries/web-sdk/reference/interfaces/Options).[`RecommendationsSearchOptions`](/libraries/web-sdk/reference/interfaces/RecommendationsSearchOptions).[`RecommendationsResultsOptions`](/libraries/web-sdk/reference/interfaces/RecommendationsResultsOptions)
...
Optional styling of the widget box. When adding boxShadow, border provide enough margin so they are visible
...
Determines the total height of the widget in the open state. If not provided 650px is taken as default.
...
### sourceDocument?[​](#sourcedocument "Direct link to sourceDocument?")

```
optional sourceDocument?: DocumentContext;
```

Information about the current document for which Glean widget will show recommendations. If not provided, the embedder page info is used.
