...
canonical: "https://developers.glean.com/api-info/indexing/authentication/token-rotation"
title: "Token Rotation | Glean Developer"
description: "This guide covers token rotation for the indexing API. You'll learn how to exchange your rotatable access token for a new access token."
fetched_at: "2026-09-01T13:22:50.164Z"
---
On this page
...
## Rotate token endpoint `/rotatetoken`[​](#rotate-token-endpoint-rotatetoken "Direct link to rotate-token-endpoint-rotatetoken")

Here is a sample request to the `/rotatetoken` endpoint.

```
 curl -X POST  https://customer-be.glean.com/api/index/v1/rotatetoken \  -H 'Authorization: Bearer <token>'
```
...
```
{  "rawSecret": "new-secret",  "createdAt": 16400000,  "rotationPeriodMinutes": 3600}
```

## Rotation period[​](#rotation-period "Direct link to Rotation period")
