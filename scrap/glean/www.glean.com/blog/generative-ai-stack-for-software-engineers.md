...
canonical: "https://www.glean.com/blog/generative-ai-stack-for-software-engineers"
title: "Generative AI for software engineers: How to build the right AI stack"
description: "Trevor Gile  | Learn how Glean helps you build a generative AI stack for software engineers with shared context, guardrails, and workflows beyond basic coding assistants."
fetched_at: "2026-09-01T13:26:35.591Z"
---
...
**Safety** – Weak guardrails increase the attack surface. In the [2025 Veracode GenAI code security report](https://www.veracode.com/resources/analyst-reports/2025-genai-code-security-report/), close to 45% of AI-generated code samples contained at least one high-severity security vulnerability.
...
[Glean](https://www.glean.com/product/overview) is designed for this role. It builds a shared system of context across tools like GitHub, Jira, Confluence, Slack, and Teams, using its Enterprise Graph to link services, incidents, tickets, owners, and design artifacts. Because Glean inherits and enforces source-system permissions, answers stay within the access boundaries engineers already have.
...
Those four tool categories map to a simpler architectural model: one layer that *understands the work* (context), and one layer where engineers *do the work* (coding and interaction surfaces).
...
For the complete tooling landscape, a detailed look at the two-layer model, real-world examples, and the evaluation priorities engineering leaders should use before scaling generative AI technologies across the software development lifecycle, read [The software engineer’s field guide to the AI stack](https://www.glean.com/resources/guides/eng-field-guide-ai-stack).
