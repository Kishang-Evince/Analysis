...
1.  Use one agent to extract key clauses from the contract.
2.  Use another to retrieve procurement policies from your internal wiki.
3.  Use a third to compare and highlight conflicts.
