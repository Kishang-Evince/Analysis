...
canonical: "https://www.glean.com/blog/glean-agents-dec-drop-2025"
title: "The new playbook for sales productivity starts with agents"
description: "Bradley Scott  | Explore eight Glean sales agents that streamline prep, accelerate deals, improve coaching, and strengthen handoffs across the sales lifecycle."
fetched_at: "2026-09-01T13:26:36.184Z"
---
...
![The new playbook for sales productivity starts with agents](https://cdn.prod.website-files.com/613513981b0efaf850830620/693a0ad2b7c7329f9cc6a2a6_DecDrop-Blogbanner.jpg)
...
Get a complete, trusted view of any customer account. The [account snapshot agent](https://www.glean.com/agent-library/account-snapshot) pulls together essential account details so sellers and cross-functional partners can walk into conversations aligned. It surfaces open opportunities, stakeholders, recent Slack or email mentions, support tickets, adoption insights, and relevant news. Everything is organized in one view, so prep work shifts from “searching” to “interpreting.”
...
A concise, confident plan for what happens next. The [deal strategy agent](https://www.glean.com/agent-library/deal-strategy) synthesizes CRM activity, call insights, internal discussions, and competitive context into a crisp deal readout. It pulls what matters, recommends actionable next steps, and reflects proven patterns from past wins and losses.
...
Get a one-page view of any competitor in minutes. Competitive positioning often requires hunting through stale docs or scattered notes. The [competitive brief agent](https://www.glean.com/agent-library/competitive-brief) eliminates that friction. It gathers recent internal insights, compiles focused web research, builds a simple feature comparison, and recommends angles to explore in discovery.
...
Deals slow down when follow-ups slip through the cracks. The [intelligent reminders agent](https://www.glean.com/agent-library/intelligent-reminders) scans your meetings, messages, emails, and docs to surface open tasks and requests. It organizes action items by confidence and urgency, giving sellers a prioritized checklist of what needs attention.
...
Get targeted coaching when you need it. The [sales call coaching agent](https://www.glean.com/agent-library/sales-call-coaching) evaluates recorded calls against your sales methodology. It identifies strengths, gaps, and risks, then provides clear, transcript-backed recommendations for what to address next.
...
Learn from what didn’t land. Understanding why a deal was lost often requires digging through call recordings, internal threads, and inconsistent CRM notes. The [deal loss insights agent](https://www.glean.com/agent-library/deal-loss-insights) analyzes the full picture and identifies root causes so teams can learn and adjust.
...
Automatically generate a complete, reliable transition document for every new customer. The [account handoff agent](https://www.glean.com/agent-library/account-handoff) reviews sales calls, emails, opportunity data, and internal notes to build a structured overview of each new customer. It captures stakeholders, sentiment, obstacles, and recommended next steps, giving AEs and CSMs a shared starting point.
...
Over the last nine months, [Glean doubled its revenue](https://www.glean.com/press/glean-surpasses-200m-in-arr-for-enterprise-ai-doubling-revenue-in-nine-months), surpassing $200M. A big part of that growth came from how our sales team works day to day with Glean.
...
And the best part is you don’t have to start from scratch. Each agent is available as a template in Glean’s [agent library](https://www.glean.com/agent-library), ready to use and ready to customize. Pick one, try it, refine it, and you’ll feel the impact quickly.

Great sales teams run on clarity and continuous improvement. These agents help you with both, right where work happens.

Explore the [December Drop](https://www.glean.com/product-drop/december-2025) for more details on this release, or [request a demo](https://www.glean.com/get-demo) to see how Glean can support your sales motion!
