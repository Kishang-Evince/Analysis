---
url: "https://www.glean.com/blog/what-is-ai-security"
canonical: "https://www.glean.com/blog/what-is-ai-security"
title: "What is AI security?"
description: "Stephanie Baladi  | Protect your AI systems from emerging security threats. Explore actionable AI security frameworks, governance strategies, and defenses."
fetched_at: "2026-09-01T13:26:56.642Z"
---
...
The regulatory landscape around AI security is getting more complex by the day. Think of it like building codes – they exist to keep everyone safe, but keeping up with the latest requirements can be challenging. From the [EU's AI Act](https://artificialintelligenceact.eu/) to industry-specific regulations, organizations must show they take AI security seriously. But this isn't just about ticking boxes – it's about building a security framework that actually protects your AI systems throughout their lifecycle.
...
-   **Granular access controls**: Implement role-based access control to limit users’ [permissions](https://www.glean.com/blog/secure-generative-ai-for-the-enterprise-requires-the-right-permissions-structure) to only what's necessary for their tasks. Limiting permissions in this way ensures that sensitive functions or data are accessible only to authorized individuals.
...
-   [**NIST AI Risk Management Framework**](https://www.nist.gov/itl/ai-risk-management-framework): A comprehensive guide to managing AI-related risks throughout development and deployment.
-   [**OWASP Top 10 for Large Language Model Applications**](https://owasp.org/www-project-top-10-for-large-language-model-applications/): A resource focused on common vulnerabilities in large language models, offering actionable strategies for mitigation.
-   [**MITRE ATLAS**](https://atlas.mitre.org/): A framework designed to map potential threats and guide the development of AI threat models.
-   [**ISO/IEC standards for AI security**](https://www.iso.org/sectors/it-technologies/ai): International standards that provide detailed best practices for securing AI systems, including guidance on risk management, data protection, and ethical considerations.
...
Learn how Glean combines [trusted security practices](https://www.glean.com/security) with powerful AI to help your team work smarter, safely.
