...
canonical: "https://www.glean.com/blog/go-agents-launch"
...
description: "Arvind Jain  | Glean Agents provide enterprises with an open, horizontal foundation for building, integrating, and governing AI agents across leading models, various applications, and business-critical workflows."
fetched_at: "2026-09-01T13:26:41.028Z"
---
...
![Glean Platform Marketecture](https://cdn.prod.website-files.com/613513981b0efaf850830620/682c28de9cb63b763e41268a_image4%20\(2\).webp)

## The open, horizontal platform for agent deployment and experimentation

Glean Agents provides unparalleled enterprise agent creation, customization, deployment capabilities, and control over where agents run and which models they use. Creating an agent begins with Glean’s **agent builder,** which allows you to start building agents using everyday natural language. For task-based agents, we’ve built advanced capabilities like branching and looping to enable granular customization of agent functionality. 

![Glean Product in action](https://cdn.prod.website-files.com/613513981b0efaf850830620/682c291a5ac4ac97d5a8f7b4_image5.gif)
...
Glean is also releasing a **hosted MCP server** for secure agent interoperability across platforms, allowing access to Glean Search, Assistant, and Agents along with direct coordination with other agents. You can run in your single-tenant environment, authorize using OAuth, and centrally manage your servers. 

**Agent observability and evals** make optimizing agent outcomes easy. These new tools provide step-by-step insights into agent behavior, allowing you to diagnose issues and iterate rapidly with full visibility into multi-step processes. Demonstrate an instrument's impact on agent behavior and outputs, and foster confident agent development and improvement. 
...
These include over **30 prebuilt agents** across sales, engineering, IT, and HR, which can be customized and deployed for everyday tasks like prospecting, ticket resolution, code review, and help desk automation. Prebuilt agents make it easy for anyone to instantly integrate them into their workflows, jump-start adoption, reduce time to value, and help teams realize business impact faster. 

**New personal agents** help employees not only stay on top of daily tasks like meeting prep and action item summaries but also execute workflows like performance reviews. These agents often leverage Glean’s new **personal graph,** which understands each user’s activities and daily tasks to provide a deeper layer of personalized context. 
...
Agents are most impactful when they can be used across entire departments and companies, but according to [BCG](https://www.bcg.com/publications/2025/closing-the-ai-impact-gap), **70%** of companies have failed to scale AI training beyond a handful of employees. Glean’s **agent library** makes it easy to scale specialized GenAI tools across your business by centralizing all of the agents created and shared by your organization.  
...
![Glean Agents Features](https://cdn.prod.website-files.com/613513981b0efaf850830620/682c2a02203abc790b70edda_image7.webp)

*Learn more about how to leverage agents in the workplace through our* [*Agents Library*](http://glean.com/agent-library)*.*

## Safely securing enterprise AI with Glean Protect

At Glean, we believe that governance doesn’t have to slow down innovation when built into the platform from day 1. Trust is the foundation of enterprise AI adoption, and we want to make it as easy as possible for you to safely integrate AI in the enterprise. **Glean Protect**, our new embedded security suite, enables organizations to get their data AI-ready and ensures users can trust agents to drive meaningful work.  
...
Discover more about Glean Agents and the power of an open, horizontal agent platform by checking out our [Glean:GO event](https://www.glean.com/events/glean-go-2025), where I’ll be onstage along with Carl Eschenbach of Workday, Eric Yuan of Zoom, Francis deSouza of Google Cloud, Sridhar Ramaswamy of Snowflake, and many more. If you’re looking to get started with transforming your business with Glean, sign up for a free [demo](https://www.glean.com/get-a-demo) today!

<span class="body-xsmall-new text-style-italic">Many Glean Agents features are now generally available, including natural language agent builder, agent library, quickstart agents, agentic reasoning engine, agent guardrails, sensitive content protection, agent sharing, model hub with new model families (Deepseek, Nova), universal model key, per-step agent model choice, per-step agent temperature control, structured query analytics agents for Snowflake Cortex, Databricks Genie, Salesforce, and Jira. Certain features like agent triggering, looping, routing, observability and evals, Glean Agents API, hosted MCP server, deep research agent, companion, AI security against prompt injection attacks, and sensitive content controls are in beta and coming soon. Learn more about the Glean Agents experience by visiting [glean.com/product/ai-agents](https://www.glean.com/product/ai-agents). The decision to purchase our services should be made based on features that are currently generally available.</span>
