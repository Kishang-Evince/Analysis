...
**Model Hosting Location - Independent Fresh Research (V2)**
...
**Sr No mapping:** rows 1-7 below map 1:1 to the same Sr No in the companion test guide [test/V2/Model Hosting Location.md](../../../../test/Glean/4.9.3%20AI%20Architecture%20&%20Models/V2/Model%20Hosting%20Location.md) - same number, same claim, doc-sourced here / tenant-tested there.
